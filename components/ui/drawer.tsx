    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "bg-[#0A0A0A]/95 backdrop-blur-2xl backdrop-saturate-150",
          "border border-white/8 shadow-[0_-32px_64px_-16px_rgba(0,0,0,0.6)]",
          "data-[vaul-drawer-direction=bottom]:border-t data-[vaul-drawer-direction=bottom]:shadow-[0_-32px_64px_-16px_rgba(0,0,0,0.6),inset_0_1px_0_0_rgba(255,255,255,0.05)]",
      ...
      >
        ...
        <div className="absolute inset-x-0 top-0 h-10 flex items-center justify-center">
          <div className="hidden h-1.5 w-12 shrink-0 rounded-full bg-white/30 group-data-[vaul-drawer-direction=bottom]/drawer-content:block shadow-[0_0_12px_rgba(255,255,255,0.2)]" />
        </div>
...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col gap-0.5 p-4 shrink-0 group-data-[vaul-drawer-direction=bottom]/drawer-content:text-center group-data-[vaul-drawer-direction=top]/drawer-content:text-center md:gap-1.5 md:text-left",
        className
      )}
      {...props}
    />
